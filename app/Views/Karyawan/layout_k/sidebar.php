        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-secondary bg-secondary" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <div class="sb-sidenav-menu-heading text-white">Pribadi</div>
                        <a class="nav-link text-white" href="../biodata_karyawan">
                        ...
                        <a class="nav-link text-white" href="../ubah_biodata">
                            <div class="sb-nav-link-icon text-white">
                                <i>
                        ...
                        <a class="nav-link text-white" href="../tugas_karyawan">
                            <div class="sb-nav-link-icon text-white">
                                <i>
